...
class RobosenseHwMonitorRosWrapper final : public rclcpp::Node, NebulaHwMonitorWrapperBase
{
  ...
  rclcpp::Subscription<nebula_msgs::msg::RawPacketArray>::SharedPtr robosense_info_sub_;
...
private:
  ...
  void ReceiveInfoMsgCallback(const nebula_msgs::msg::RawPacketArray::SharedPtr info_msg);
